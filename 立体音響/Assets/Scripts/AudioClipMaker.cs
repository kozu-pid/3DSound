// supported by
// https://github.com/Suzeep/audioclip_maker/blob/master/Assets/Scripts/AudioClipMaker.cs
...
public class AudioClipMaker : MonoBehaviour
{
    ...
    private float convertByteToFloatData(byte[] byte_data, int idx, int bit_per_sample)
    {
        ...
        switch (bit_per_sample)
        {
            ...
            case BIT_16:
                {
                    // エラー原因，byte_data.Lengthよりidxが大きくなる
                    // Debug.Log("byte_data.length : " + byte_data.Length + ", idx : " + idx);
